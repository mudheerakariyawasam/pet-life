...
<body>
    ...
    <div class="content">
        ...
        <div class="container">
        <br/>
<div class="employee-title">Client List</div><hr>
<br/>
...
<div class="date-input">
  ...
  if(isset($_REQUEST['searchsubmit'])){
    ...
    $sql = "SELECT * FROM pet_owner WHERE owner_regdate BETWEEN '$startdate' AND '$enddate'";
    ...
    if($result->num_rows > 0){
        ...
        <table>
          <thead>
            <tr>
              ...
              <th>Owner Email</th>
              <th>Owner Conatact No</th>
              <th>Owner Address</th>
              <th>Owner Registered Date </th>
              <th>Owner Status</th> 
            </tr>
          </thead>
          <tbody>';
      while($row = $result->fetch_assoc()){
        echo '<tr>
              ...
              <td>'.$row["owner_contactno"].'</td>
              <td>'.$row["owner_address"].'</td>
              <td>'.$row["owner_regdate"].'</td>
              <td>'.$row["owner_status"].'</td>
            </tr>';
      }
      echo '<tr>
