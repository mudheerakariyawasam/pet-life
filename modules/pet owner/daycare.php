...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $daycare_date = $_POST['daycare_date'];
   

    $sql = "INSERT INTO daycare (pet_id, pet_name, daycare_date) VALUES ('$pet_id','$pet_name','$daycare_date')";
        ...
        <div class="container">
            ...
            <form method="POST" action="">
                ...
                <div class="form-content">
                    ...
                    <input type="date" name="daycare_date" placeholder="daycare date" required>
                </div>
            ...
            <div class="d-text">
                ...
                <div class="table">
                    ...
                    <table>
                        ...
                        <?php
                        $sql = "SELECT e.pet_id, e.pet_name, e.daycare_date FROM daycare e 
                    INNER JOIN pet_owner o ON o.owner_id = e.owner_id 
